...
export const ObjectTyped = {
  ...
  values: <T extends object>(obj: T): Array<T[keyof T]> => Object.values(obj) as Array<T[keyof T]>,
  entries: <T extends object>(obj: T): Array<[keyof T, ValuesOf<T>]> => Object.entries(obj) as Array<[keyof T, ValuesOf<T>]>,
};
